...
static std::atomic<uintptr_t> g_context_counter{1000};  // Start at different offset
...
int llama_tokenize(
    ...
    int32_t result_size = static_cast<int32_t>(g_stub_config.tokenize_result.size());
...
int llama_detokenize(
    ...
    int32_t result_size = static_cast<int32_t>(g_stub_config.detokenize_result.size());
